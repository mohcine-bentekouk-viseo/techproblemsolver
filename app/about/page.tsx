  ...
  const timeline = [
    {
      year: "2023",
      title: "The Beginning",
      description: "Started as a simple blog to help friends and family with tech problems",
      icon: "🌱"
    },
    {
      year: "2024", 
      title: "Growing Community",
      description: "Reached 10,000+ monthly visitors and expanded to cover more devices",
      icon: "📈"
    },
    {
      year: "2025",
      title: "50K+ Problems Solved",
      description: "Now helping over 50,000 people monthly solve their tech issues",
      icon: "🎯"
    }
  ];
  ...
  const team = [
    {
      ...
      avatar: "👨‍💻",
      expertise: ["Mobile Devices", "Network Issues", "Software Troubleshooting"]
    },
    {
      name: "Sarah Chen", 
    ...
    },
    {
      ...
      avatar: "👨‍🔧",
      expertise: ["Hardware Repair", "Performance Optimization", "System Diagnostics"]
    }
  ];
      ...
      <section className="px-6 pt-8 pb-16 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-xl leading-8 text-gray-600 max-w-3xl mx-auto mb-8">
            ...
            That's why we're dedicated to providing <strong>simple solutions</strong> to everyday tech problems.
          </p>
          ...
          <Card className="p-12 text-center border-0 shadow-soft-lg bg-gradient-to-r from-primary-50 to-secondary-50">
            <div className="max-w-4xl mx-auto">
              ...
              <blockquote className="text-2xl text-gray-700 italic leading-relaxed mb-8">
                "To bridge the gap between complex technology and simple solutions, 
                empowering everyone to solve their tech problems with confidence."
              </blockquote>
              ...
              <div className="grid md:grid-cols-3 gap-8 mt-12">
                {values.map((value, index) => (
                  <div key={value.title} className="text-center">
                    <div className={`w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br ${value.color} flex items-center justify-center text-white text-2xl shadow-soft`}>
                      {value.icon}
                    </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600">
              A dedicated team of tech enthusiasts helping you solve problems every day
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {team.map((member, index) => (
              <Card key={member.name} className="p-8 text-center hover:shadow-soft-lg transition-all duration-300 border-0">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap justify-center gap-2">
                    {member.expertise.map((skill) => (
                      <span key={skill} className="px-3 py-1 bg-primary-100 text-primary-800 text-xs font-medium rounded-full">
                        {skill}
                      </span>
                    ))}
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                step: "2", 
                title: "Test",
                description: "Every solution is tested on real devices before publishing",
                icon: "🧪"
              },
              {
                step: "3",
                title: "Simplify",
                description: "Complex technical processes become easy step-by-step guides",
                icon: "✨"
              },
              {
                step: "4",
                title: "Support",
                description: "We're here to help if you need additional assistance",
                icon: "🤝"
              }
            ].map((step, index) => (
